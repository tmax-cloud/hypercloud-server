...
import (
	...
	"github.com/tmax-cloud/hypercloud-server/util"
	"k8s.io/klog"
	// "encoding/json"
)
...
func List(res http.ResponseWriter, req *http.Request) {
	...
	hcrList, msg, status := util.ListCluster(userId)

	util.SetResponse(res, msg, hcrList, status)
	return
}
...
func ListOwner(res http.ResponseWriter, req *http.Request) {
	...
	hcrList, msg, status := util.ListOwnerCluster(userId)
	util.SetResponse(res, msg, hcrList, status)
	return
}
...
func ListMember(res http.ResponseWriter, req *http.Request) {
	...
	hcrList, msg, status := util.ListMemberCluster(userId)
	util.SetResponse(res, msg, hcrList, status)
	return
}
